...
public class NewPostFragment extends BaseFragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mDatabaseOne = FirebaseDatabase.getInstance("https://replicator-37607-867cf.firebaseio.com")
                .getReference();
    ...
    private void submitPost() {
        ...
        final int category = binding.rgType.getCheckedRadioButtonId();

        System.out.println(category);


        // 0:2131231272 1:2131231273
                ...
                new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        if (user == null) {
                            ...
                            switch (category) {
                                case 2131231273:
                                    writeNewPost(userId, user.username, title, body, category, mDatabaseOne);
                                    break;
                                default:
                                    writeNewPost(userId, user.username, title, body, category, mDatabase);
                                    break;
                            }
                        }
    ...
    private void writeNewPost(String userId, String username, String title, String body, int category, DatabaseReference reference) {
        // Create new post at /user-posts/$userid/$postid and at
        // /posts/$postid simultaneously
        String key = reference.child("posts").push().getKey();
        Post post = new Post(userId, username, title, body, category);
